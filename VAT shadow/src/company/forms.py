...
class CompanyForm(forms.ModelForm):
    ...
    company_code = forms.CharField(widget=forms.NumberInput(attrs={'placeholder': 'Enter company code'}))
    contact_person = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Enter contact person name'}))
    phone_number = forms.CharField(widget=forms.NumberInput(attrs={'placeholder': 'Enter phone number'}))
